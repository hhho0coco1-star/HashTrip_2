...
<body>
    <div class="container">
        ...
        <header class="plan-header">
            <input type="text" id="tripTitle" class="trip-title-input" placeholder="여행 제목을 입력하세요">
            <div class="trip-status">
                <span id="statusBadge" class="status-badge status-planning">계획 중</span>
            </div>
        </header>

        <!-- 장소 추가 버튼 (계획 상태에서만) -->
        <div id="addPlaceSection" class="add-place-section">
            <button id="addPlaceBtn" class="btn btn-primary">
        ...
        <div id="reviewSection" class="review-section hidden">
            ...
            <textarea id="totalReview" class="total-review-input" placeholder="여행 후기를 작성하세요"></textarea>
        ...
        <div class="action-buttons">
            <div class="visibility-toggle">
                <label>
                    <input type="checkbox" id="isPublic"> 공개
                </label>
            </div>
            <button id="startTripBtn" class="btn btn-success">여행 시작!</button>
            <button id="completeTripBtn" class="btn btn-complete hidden">여행 완료</button>
    ...
    <div id="mapModal" class="modal hidden">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button id="confirmPlace" class="btn btn-primary">선택 완료</button>
            </div>
        </div>
    </div>
